						...
						$.ajax({
							...
							success: d =>{
								...
								$.each(d.allist,(i,j)=>{
									...
									if(i<3){
										$('<h4><img src="'+j.imgUrl+' width="20" height="20" alt=""></img>'+j.airportName+' '+j.departureTime+' '+j.arrivalTime+' '+j.departAirport+' '+j.arrivalAirport+' '+j.departDate+' '+j.arrivalDate+' '+j.price+'</h4>')
										.appendTo('#pnbd_01');
									}
								});
								...
								$.each(d.arlist,(i,j)=>{
									if(i<3){
										$('<h4> <img src="'+j.imgUrlR+' width="20" height="20" alt=""></img>'+j.airportNameR+' '+j.departureTimeR+' '+j.arrivalTimeR+' '+j.departAirportR+' '+j.arrivalAirportR+' '+j.departDateR+' '+j.arrivalDateR+' '+j.priceR+' '+'<button id="pp_02" type="button" class="btn btn-primary">결제하기</button></h4>')
										.appendTo('#pnbd_02');
									}
								});
